...
/*! @name PIO0_21 (number 61), J2[2]/P0_21-CLKOUT-SPIFI_CLK
  @{ */
#define BOARD_INITPINS_awss_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_INITPINS_awss_PORT 0U   /*!<@brief PORT device name: 0U */
#define BOARD_INITPINS_awss_PIN 21U   /*!<@brief 0U pin index: 21 */
                                      /* @} */
