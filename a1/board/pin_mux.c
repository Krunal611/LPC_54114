...
pin_labels:
- {pin_num: '61', pin_signal: PIO0_21/CLKOUT/FC0_TXD_SCL_MISO/CTIMER3_MAT0, label: 'J2[2]/P0_21-CLKOUT-SPIFI_CLK', identifier: awss}
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t awss_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_21 (pin 61)  */
    GPIO_PinInit(BOARD_INITPINS_awss_GPIO, BOARD_INITPINS_awss_PORT, BOARD_INITPINS_awss_PIN, &awss_config);
